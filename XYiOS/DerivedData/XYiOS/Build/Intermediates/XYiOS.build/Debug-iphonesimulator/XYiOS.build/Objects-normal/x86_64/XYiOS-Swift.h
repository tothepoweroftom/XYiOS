...
SWIFT_CLASS("_TtC5XYiOS11AppDelegate")
...
@property (nonatomic, readonly, strong) ShapeView * _Nonnull shapeView;
...
SWIFT_CLASS("_TtC5XYiOS11AudioPlayer")
...
@interface CABasicAnimation (SWIFT_EXTENSION(XYiOS))
...
@interface CASpringAnimation (SWIFT_EXTENSION(XYiOS))
/// Configures basic options for a CABasicAnimation.
...
@interface CIColor (SWIFT_EXTENSION(XYiOS))
@end
...
SWIFT_CLASS("_TtC5XYiOS16CanvasController")
...
SWIFT_CLASS("_TtC5XYiOS7Ellipse")
...
SWIFT_CLASS("_TtC5XYiOS5Curve")
@interface Curve : Shape
- (void)batchUpdates:(SWIFT_NOESCAPE void (^ _Nonnull)(void))updates;
- (void)updatePath;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC5XYiOS8Gradient")
...
@property (nonatomic, readonly, strong) GradientView * _Nonnull gradientView;
...
SWIFT_CLASS("_TtC5XYiOS13GradientLayer")
...
@property (nonatomic, strong) CIImage * _Nonnull output;
@property (nonatomic, strong) dispatch_queue_t _Nonnull filterQueue;
@property (nonatomic) BOOL renderImmediately;
- (nonnull instancetype)initWithView:(UIView * _Nonnull)view SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithCopyView:(View * _Nonnull)copyView SWIFT_UNAVAILABLE;
@end


@interface Image (SWIFT_EXTENSION(XYiOS))
@end
...
SWIFT_CLASS("_TtC5XYiOS10ImageLayer")
...
SWIFT_CLASS("_TtC5XYiOS5Layer")
@interface Layer : CALayer
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull rotationKey;)
+ (NSString * _Nonnull)rotationKey SWIFT_WARN_UNUSED_RESULT;
/// The value of the receiver’s current rotation state.
/// This value is cumulative, and can represent values beyong +/- π
@property (nonatomic, readonly) double rotation;
...
SWIFT_CLASS("_TtC5XYiOS7Polygon")
...
SWIFT_CLASS("_TtC5XYiOS5Movie")
@interface Movie : View
@property (nonatomic, copy) NSString * _Null_unspecified filename;
@property (nonatomic, strong) AVQueuePlayer * _Nullable player;
@property (nonatomic, strong) AVPlayerItem * _Nullable currentItem;
@property (nonatomic, copy) void (^ _Nullable reachedEndAction)(void);
...
/// The original width/height ratio of the receiver when it was initialized.
@property (nonatomic, readonly) double originalRatio;
@property (nonatomic, readonly, strong) PlayerLayer * _Nonnull movieLayer;
@property (nonatomic, readonly, strong) MovieView * _Nonnull movieView;
@property (nonatomic, readonly) BOOL playing;
/// The current rotation value of the view. Animatable.
///
/// returns:
...
/// By default, the movie should loop then the method calls <code>stop()</code> and <code>play()</code>.
...
@interface NSObject (SWIFT_EXTENSION(XYiOS))
...
SWIFT_CLASS("_TtC5XYiOS9QuadCurve")
...
SWIFT_CLASS("_TtC5XYiOS9Rectangle")
...
SWIFT_CLASS("_TtC5XYiOS14RegularPolygon")
...
SWIFT_CLASS("_TtC5XYiOS14ScreenRecorder")
@interface ScreenRecorder : NSObject <RPPreviewViewControllerDelegate>
@property (nonatomic, readonly, strong) RPScreenRecorder * _Nonnull recorder;
@property (nonatomic, strong) RPPreviewViewController * _Nullable preview;
@property (nonatomic, copy) NSSet<NSString *> * _Nullable activities;
...
@interface Shape (SWIFT_EXTENSION(XYiOS))
...
/// Extension for CAShapeLayer that allows overriding the actions for specific properties.
SWIFT_CLASS("_TtC5XYiOS10ShapeLayer")
...
SWIFT_CLASS("_TtC5XYiOS9TextShape")
...
SWIFT_CLASS("_TtC5XYiOS8Triangle")
...
@interface UIColor (SWIFT_EXTENSION(XYiOS))
@end


@interface UIGestureRecognizer (SWIFT_EXTENSION(XYiOS))
@property (nonatomic, strong) UIView * _Nullable referenceView;
@property (nonatomic, strong) id _Nullable actionHandler;
- (nonnull instancetype)initWithView:(UIView * _Nonnull)view;
@end


@interface UIImage (SWIFT_EXTENSION(XYiOS))
...
@interface UILongPressGestureRecognizer (SWIFT_EXTENSION(XYiOS))
@end


@interface UIPanGestureRecognizer (SWIFT_EXTENSION(XYiOS))
@end


@interface UIPinchGestureRecognizer (SWIFT_EXTENSION(XYiOS))
@end


@interface UIRotationGestureRecognizer (SWIFT_EXTENSION(XYiOS))
...
- (nonnull instancetype)initWithView:(UIView * _Nonnull)view action:(void (^ _Nonnull)(double, double, UIGestureRecognizerState))action;
@end


@interface UIScreenEdgePanGestureRecognizer (SWIFT_EXTENSION(XYiOS))
@end


@interface UISwipeGestureRecognizer (SWIFT_EXTENSION(XYiOS))
@end


@interface UITapGestureRecognizer (SWIFT_EXTENSION(XYiOS))
@end


@interface UIView (SWIFT_EXTENSION(XYiOS))
@end


@interface UIViewController (SWIFT_EXTENSION(XYiOS))
...
@interface View (SWIFT_EXTENSION(XYiOS))
/// Creates a flattened image of the receiver and its subviews / layers.
///
/// returns:
/// A new Image
...
/// \param keyPath The identifier to animate
///
/// \param toValue The value to which the identifier will be animated
///
- (void)animateKeyPath:(NSString * _Nonnull)keyPath toValue:(id _Nonnull)toValue;
...
SWIFT_CLASS("_TtC5XYiOS5Wedge")
@interface Wedge : Shape
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC5XYiOS9WorkSpace")
@interface WorkSpace : CanvasController
@property (nonatomic, strong) Timer * _Null_unspecified timer;
- (void)setup;
- (void)draw;
- (void)setupTimer;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
